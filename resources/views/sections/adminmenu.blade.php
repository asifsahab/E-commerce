        ...
        <div class="header-middle pt--10 pb--10">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-3 ">
                        <a href="/">
                            <h1 class="text-primary font-weight-bold">Easy Shop</h1>
                        </a>
                    </div>
                    <div class="col-lg-2">
                        ...
                        <div class="main-navigation flex-lg-right">
                            <ul class="main-menu menu-right ">
                                ...
                                <li class="menu-item has-children">
                                    ...
                                    <ul class="sub-menu">
                                        <li><a class="font-weight-bold" href="{{ route('addproducts') }}"> Add
                                                Products</a></li>
                                        <li>
                                ...
                                <li><a class="font-weight-bold" href="{{ route('payment') }}">Add Payment</a></li>

                                </li>
                                <li><a class="font-weight-bold" href="{{ route('reciept') }}">Add Reciept</a></li>
